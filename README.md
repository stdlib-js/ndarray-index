...
```javascript
import ndindex from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-index@v0.1.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { cartesianIndex, linearIndex } from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-index@v0.1.1-esm/index.mjs';
```
